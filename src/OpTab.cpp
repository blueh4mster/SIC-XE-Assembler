...
void deleteOpTab() {
	cout<<"errors displayed in output/listFile.txt in pass 1\n";
	deleteFile("../output/objectFile.txt");
...
void deleteOpTab3(){
	cout<<"errors displayed in output/listFile.txt in pass 2\n";
	deleteFile("../output/objectFile.txt");
}